...
document.addEventListener('DOMContentLoaded', function() {
    checkWindowSize();
    document.getElementById('r_click').addEventListener('click', function() {
        window.location.href = '../../templates/avatar2.html';
    });
    
    document.getElementById('l_click').addEventListener('click', function() {
        window.location.href = '../../templates/avatar8.html';
    });
    ...
    //     window.location.href = '../Avatar1/test_first_page.html';
    // });
});